        ...
        <div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-2">
                ...
                <div className="flex gap-2">
                    ...
                    <button onClick={addLink} className="btn flex gap-2 items-center cursor-pointer">
...
<CldUploadButton
                ...
                place-items-center bg-slate-100 rounded-md relative ${imageUrl && "pointer-events-none"}`}
